#!/bin/bash
#SBATCH -o /home/s1687314/Planning/Tree_enc_dec/slogs/plan.summ
#SBATCH -e /home/s1687314/Planning/Tree_enc_dec/slogs/plan.summ
...
# ====================
# need to update
export RAW_DATA_DIR=/home/${USER}/Planning/Tree_enc_dec/outputs.cnn_dm/
export SCRATCH_DIR=/disk/scratch/${USER}/outputs.cnn_dm/
...
# ====================
sh ./scripts_cnn.mlp/train_cnn_plan.sh
