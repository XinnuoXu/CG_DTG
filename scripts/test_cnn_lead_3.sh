...
MODEL_PATH=./outputs.cnn_dm/models.freeze_tmt/
EXT_PATH=./outputs.cnn_dm/models.ext/
ABS_PATH=./outputs.cnn_dm/models.bartbase/
LOG_PATH=./outputs.cnn_dm/logs.freeze_tmt/
