...
#sh scripts_d2t.lang/train_reinforce_encdec_partial.sh br
#sh scripts_d2t.lang/train_reinforce_encdec_partial.sh cy
#sh scripts_d2t.lang/train_reinforce_encdec_partial.sh ga
sh scripts_d2t.lang/train_reinforce_encdec_partial.sh ru
