...
class Trainer(object):
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats, report_stats):
        ...
        for batch in true_batchs:
            ...
            mask_src_sents = batch.mask_src_sents
            nsent_src = batch.nsent_src

            tgt = batch.tgt
            mask_tgt = batch.mask_tgt
            tgt_sents = batch.tgt_sents
            mask_tgt_sents = batch.mask_tgt_sents

            s2t = batch.s2t

            outputs, tgt, mask_tgt, entropy_map = self.model(src, src_sents, tgt, tgt_sents, mask_src, mask_src_sents, mask_tgt, mask_tgt_sents, nsent_src, s2t)
