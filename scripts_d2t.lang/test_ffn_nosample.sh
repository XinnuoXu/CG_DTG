...
# ntriple=2; test_from=4000; test_graph_selection_threshold=0.44
# ntriple=3; test_from=4000; test_graph_selection_threshold=0.62
# ntriple=4; test_from=4000; test_graph_selection_threshold=0.48
# ntriple=7; test_from=4000; test_graph_selection_threshold=0.005
