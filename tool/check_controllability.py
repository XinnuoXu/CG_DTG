...
data_path = './outputs.webnlg/logs.partial_src/test.res.3000'
output_path = './outputs.webnlg/temp_tgt_control.txt'
...
def version_1():
    ...
    srcs = [line.strip().replace('<pad>', '').split('<s>') for line in open(raw_src)]
