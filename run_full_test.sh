...
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 2 t5-base 500 false 0.005
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 3 t5-base 1500 false 0.01
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 4 t5-base 2000 false 0.01
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 7 t5-base 5500 false 0.005

sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 2 t5-base 500 true 0.005
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 3 t5-base 1500 true 0.01
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 4 t5-base 2000 true 0.01
sh ./scripts_d2t.ntriple_full/test_ffn_nosample.sh 7 t5-base 55000 true 0.005
