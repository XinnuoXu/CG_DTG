...
#sh ./tool/grid_search_nshort_randombase_nosample.sh 2 500 > tool/grid.res.ntriples.single/grid.res.2.rl
#sh ./tool/grid_search_nshort_randombase_nosample.sh 3 1500 > tool/grid.res.ntriples.single/grid.res.3.rl
#sh ./tool/grid_search_nshort_randombase_nosample.sh 4 500 > tool/grid.res.ntriples.single/grid.res.4.rl
#sh ./tool/grid_search_nshort_randombase_nosample.sh 5 3000 > tool/grid.res.ntriples.single/grid.res.5.rl
#sh ./tool/grid_search_nshort_randombase_nosample.sh 6 2000 > tool/grid.res.ntriples.single/grid.res.6.rl
#sh ./tool/grid_search_nshort_randombase_nosample.sh 7 2000 > tool/grid.res.ntriples.single/grid.res.7.rl
