...
LOG_PATH=${BASE_PATH}/short_single.logs.re.nn.thresholdbase_nosample/
...
# ntriple=4; test_from=2000; test_graph_selection_threshold=
# ntriple=5; test_from=3000; test_graph_selection_threshold=
...
# ntriple=6; test_from=3000; test_graph_selection_threshold=
# ntriple=7; test_from=6000; test_graph_selection_threshold=
