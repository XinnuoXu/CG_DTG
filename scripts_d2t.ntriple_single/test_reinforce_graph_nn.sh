...
# ntriple=3; test_from=5000; test_graph_selection_threshold=0.98(?)
# ntriple=4; test_from=4000; test_graph_selection_threshold=0.86
# ntriple=5; test_from=4500; test_graph_selection_threshold=0.6
# ntriple=6; test_from=2500; test_graph_selection_threshold=0.44
# ntriple=7; test_from=4000; test_graph_selection_threshold=0.62
